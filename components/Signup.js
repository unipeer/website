    ...
    <div className="p-6 mb-4" id="signup">
      <div className="relative border border-gray-200 rounded-lg px-4 py-6 shadow sm:px-6 sm:py-8 lg:p-12 xl:p-16">
        ...
        <p className="mt-2 max-w-2xl text-base text-gray-700">
          Sign up for our
          newsletter and we'll email you as soon as we launch and roll out
          new features. You'll be one of the first to know about our launch
          and get early access.
        </p>
        <form method="POST" className="py-4" netlify>
          <div className="sm:flex justify-center">
              ...
              />
            <button className="mt-4 relative sm:mt-0 sm:h-auto sm:ml-4 block w-full sm:w-auto border border-transparent px-6 py-3 text-base font-semibold leading-snug bg-indigo-600 text-white rounded-md shadow-md hover:bg-indigo-500 focus:outline-none focus:bg-indigo-500 transition ease-in-out duration-150">
              Subscribe
            </button>
          </div>
        </form>
